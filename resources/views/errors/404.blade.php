...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | PT KIMPAI DYNA TUBE</title>
    ...
    <style>
        ...
        .error-icon {
            font-size: 64px; color: #3b82f6; margin-bottom: 20px;
        }
...
<body>
    <div class="error-container">
        ...
        <p>Maaf, alamat atau menu yang Anda tuju tidak tersedia, telah dipindahkan, atau mungkin salah ketik.</p>
